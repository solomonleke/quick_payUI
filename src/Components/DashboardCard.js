...
export default function DashboardCard({color,title,value, icon}) {
  return (
    <Box bg={color} cursor={"pointer"} transition={"0.5s "} _hover={{bg: "blue.blue100"}} boxShadow={"4px 6px 12px 3px #B5B5B5 "} w={["100%","100%","48%","48%","24%"]} mt={["15px","10px","10px","10px","2px"]} p="20px" rounded="8px" color={"#fff"}>
      <HStack>
        <Box>
