                ...
                <div className='container'>
                    ...
                    <Flex justifyContent={"center"} >
                        <Box w={["100%", "100%", "50%", "50%", "50%"]} my="32px">
                            ...
                            <Header title={"sign up for a Vendor account"} />
                                ...
                                <Stack spacing={"22px"} mt="32px">
                                    ...
                                    <Button  onClick={SignInCus} isLoading={Loading}>Create Account</Button>
                                </Stack>

                                <Text fontWeight={"500"} color="blue.blue400" textAlign={"center"} mt="32px" >Already have an account ? <Box as="span" onClick={() => nav("/login")} color="yellow.yellow500">Sign in</Box></Text>
                            </div>
